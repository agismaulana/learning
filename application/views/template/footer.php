            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SDN Pondok Petir 01 <?= date('Y')?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Selamat Menikmati Hari - Hari Nya
                </div>
    ...
    <!-- CKeditor -->
    <script src="<?= base_url('template')?>/js/plugins/ckeditor/ckeditor.js"></script>
    ...
    <script>
        ...
        $('.form-check-input').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(){
                    document.location.href = '<?= base_url('level/access/');?>' + levelId;
                }
            });
        });
    </script>
