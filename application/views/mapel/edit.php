        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control" placeholder="Masukkan Judul" value="<?= $mapel['title']?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="kelas" id="kelas" class="custom-select" disabled>
                        <option value="<?= $mapel['kelas']?>">Kelas <?= $mapel['kelas']?></option>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="waktu" id="waktu" value="<?= $mapel['waktu']?>" disabled>
                </div>
            </div>
